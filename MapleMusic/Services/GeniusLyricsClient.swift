...
actor GeniusLyricsClient {
    ...
    func lyrics(for track: Track, accessToken: String) async throws -> Lyrics? {
        ...
        searchRequest.setValue("MapleMusic/0.9.1 (iOS)", forHTTPHeaderField: "User-Agent")
        ...
        pageRequest.setValue(
            "Mozilla/5.0 (iPhone; CPU iPhone OS 18_0 like Mac OS X) AppleWebKit/605.1.15 Mobile/15E148 MapleMusic/0.9.1",
